  ...
  return (
    ...
    >
      <div className="relative">
        <div className="bg-secondary shadow-[inset_0_-5px_8px_rgba(0,0,0,0.12)] aspect-square flex items-center justify-center hover:bg-[#7CD1FD] transition-colors duration-300">
          <img 
            src={category.imagen} 
            alt={category.nombre} 
